...
export const metadata: Metadata = {
  title: 'About SalaryHog',
  description: 'Learn about SalaryHog, the free salary take-home pay calculator for all 50 states.',
};

export default function AboutPage() {
  return (
    <main className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">About SalaryHog</h1>

      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-4 text-gray-700 leading-relaxed">
        <p>
          SalaryHog is a free salary calculator that shows your actual take-home pay after federal and state taxes. We cover all 50 states plus Washington D.C. with 2025 tax bracket data.
        </p>
        <p>
          Whether you&apos;re evaluating a job offer, negotiating a raise, or just curious how much of your paycheck you actually keep, SalaryHog gives you a clear, accurate breakdown in seconds — no account required.
        </p>
        <p>
