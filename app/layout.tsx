...
export const metadata: Metadata = {
  title: 'PayBreakdown — Free Salary & Take-Home Pay Calculator',
  ...
  return (
    <html lang="en">
      <body className={`${geist.className} antialiased bg-gray-50 text-gray-900`}>
        {/* TODO: Add GA4 script tag with your measurement ID */}
        <Header />
        ...
        <footer className="bg-gray-900 text-gray-400 py-12 mt-16">
          <div className="max-w-5xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              {/* Col 1 */}
              <div>
                <p className="text-white font-bold text-lg mb-2">PayBreakdown</p>
            ...
            <div className="border-t border-gray-800 pt-6 space-y-3">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 text-xs text-gray-500">
                <span>© 2025 PayBreakdown. Data updated for the 2025 tax year.</span>
